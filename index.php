...
<head>
    ...
    <!-- Get @title variable from constants.php -->
    <title><?php echo @$title; ?></title>

    <!-- [ FONT-AWESOME ICON ] -->
    <!-- [ FONT-AWESOME ] library contains many small icons like diamond, newspaper, etc which are used later -->
        ...
        <section class="main-heading" id="home">
            <div class="overlay">
                <div class="container">
                    <div class="row">
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            <h1 class="main-heading-title">ABC Railway Corporation</h1>

                            <p class="main-heading-text">The ABC Railway Corporation is 150 years old and it runs a
                                unilaterally designed track system of 1067mm cape gauge. Only 30km of its track
                                distribution is in double track and that is within Nagpur area.
                                <br />The ABC railway narrow gauge network is approximately 3,500 km long and is
                                currently being extended by a narrow gauge line between Nagpur and the Mumbai - Port
                                Dadar line and a 275 km long standard gauge line between Nagpur – Pune – Gwalior.
                            </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center black">
                        ...
                        <p class="a-slog">Developed By <?php echo $developer_name; ?></p>
                    </div>
                </div>
                ...
                <div class="row about-box">
                    ...
                    <div class="col-sm-4 text-center">
                        <div class="margin-bottom">
                            ...
                            <h4>Pay Securely</h4>
                            <p class="black">Online payment. (With Upto 50% Refund Policy)</p>
                        </div>
                    </div>
                </div>
            </div>
